		...
		<form name="downloadproduct" id="downloadproduct" method="post"
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td>
						<input class="btn btn-default" type="submit" name="submit_token" id="submit_token"
							value="<?php echo JText::_('COM_REDSHOP_SUBMIT_TOKEN'); ?>"/>
			...
			<div>
				<form name="downloadproduct" id="downloadproduct" method="post"
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td colspan="2"><input class="btn btn-default" type="submit" name="submit" value="Download"/>
							</td>
						</tr>
					</table>
				</form>
